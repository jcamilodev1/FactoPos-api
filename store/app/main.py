...
from Controller import clientcontroller, FacturaController, ProductController, FacturaProductsController, UserrController
...
app.include_router(UserrController.router, prefix="/User", tags=["User"])
